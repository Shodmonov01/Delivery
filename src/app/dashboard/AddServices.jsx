...
import AdminAddServiceModal from "../../components/admin/service/AddServiceModal";
import AdminDelServiceModal from "../../components/admin/service/DeleteServiceModel";
import AdminEditServiceModal from "../../components/admin/service/EditServiceModal";
  ...
  const getData = async () => {
    try {
      const { data } = await axios.get(
        `${BASE_URL}/a_api/admin_panel/service_get_post_views/?page=${pageId}`
      );
  ...
  return  (
    <AdminLayout>
      <div className="p-4 min-h-[60vh]">
        ...
        <div>
          <div className="w-[100%] inline-block rounded-lg overflow-x-auto border shadow-2xl">
