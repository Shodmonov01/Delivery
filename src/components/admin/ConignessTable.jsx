...
import AdminDelConModal from "./b/deleteConsignees";
import { DownloadTableExcel } from "react-export-table-to-excel";

const ConignessTable = () => {
    ...
    <div>
      <div>
        ...
        <div className="w-[100%] inline-block overflow-x-auto rounded-lg border">
                        ...
                        <td className="text-center align-middle">
                          <div className="flex justify-center items-center">
                            <div
                              className="mr-3"
                              onClick={() =>
                                navigate(`/editconsignees/${item?.id}`)
                              }
                            >
                              <img
                                src={"/edit.svg"}
          ...
          <table
            className="w-[100%] overflow-x-auto table hidden"
            ref={tableRef}
            id="content"
          >
            <thead className="w-full">
