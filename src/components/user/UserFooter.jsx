...
const UserFooter = () => {
  return (
    <div className="w-[100%]  bg-[#0F172A] pb-4">
      <div className={`sm:hidden pt-[50px] px-[5%] flex flex-col justify-center}`}>
        ...
        <div className="w-[90%] mx-auto grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-8 pt-8">
